...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/soumen-samanta-029aaa239/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    icon: Instagram,
    url: "https://www.instagram.com/soumen.programmer/hl=id",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@soumen.programmer",
    icon: Facebook,
    url: "https://www.facebook.com/soumen.programmer",
    color: "#1877F2",
...
const SocialLinks = () => {
  ...
  const [instagram, twitter, github, facebook] = otherLinks;
